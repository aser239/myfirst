...
public class StudentCourseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enterSelectCourse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), TeacherCourseListActivity.class));

            }
        });

        Button enterCourseList = view.findViewById(R.id.enterCourseList222);
        enterCourseList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), StudentCourseListActivity.class));
