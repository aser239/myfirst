...
import com.example.myapplication.TeacherActivity.UnfinishedCourseDetailActivity;
...
//学生选课的详情
public class StudentCourseListDetailActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studentcourselistdetail);
    ...
    public void init() {
        ...
        quit.setOnClickListener(v -> {
            ...
            startActivity(new Intent(StudentCourseListDetailActivity.this, StudentCourseListActivity.class));
            finish();
        });
    }
    ...
    private final Handler handler = new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (code == 200) {
                ...
                Toast.makeText(StudentCourseListDetailActivity.this, "查看失败！",
